...
public class AddressBookController {
   ...
   */
    ...
    private void openSearch(){
        ...
        final String mobile=detailPanel.getMobileField().getText();
        final String email=detailPanel.geteMailField().getText();
        final String city=detailPanel.getCityField().getText();
        int reply = JOptionPane.showConfirmDialog(
                ...
                " Email Id :"+email+
                " City :"+city+ "  :", 
                "ThankYou", JOptionPane.OK_OPTION);
         /*dialog =  new ContactDialog("Searched Entries");
        final String originalName=detailPanel.getNameField().getText();
        dialog.getPanel().setName(detailPanel.getNameField().getText());
        dialog.getPanel().setMobile(detailPanel.getMobileField().getText());
        dialog.getPanel().seteMail(detailPanel.geteMailField().getText());
